    ...
    <div class="contanier p-0">
        <div class="card p-0">
            ...
            <div class="card-body p-2">
                <form action="{{ route('meal-price.store') }}" enctype="multipart/form-data" id="meal-form" method="POST">
                    @csrf
                    <div class="row row-cols-2 px-4">
                        <div class="col">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('name') is-invalid @enderror"
                                    id="name" name="name" placeholder="Enter Meal Name" value="{{ old('name') }}">
                                @error('name')
                        ...
                        <div class="col">
                            <div class="mb-3">
                                <label for="price" class="form-label">Meal Price : <span class="text-danger">*</span> </label>
